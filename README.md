...
![](https://github.com/YushiOMOTE/perde/blob/master/assets/json.svg?raw=true)
![](https://github.com/YushiOMOTE/perde/blob/master/assets/yaml.svg?raw=true)
![](https://github.com/YushiOMOTE/perde/blob/master/assets/msgpack.svg?raw=true)

#### Benchmark note

When deserializing,

* `perde`: Doesn't perform type checking. Just create `dict` or `list` accordingly. The same behaviour of exisiting `json` etc.
* `perde_*_as`: Performing type checking and conversion, i.e. deserialize as specified types.
